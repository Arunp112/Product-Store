  ...
  return (
    <header className=" sticky top-0 z-50 p-4 shadow bg-white dark:bg-gray-900 flex justify-between items-center">
      <div className=" flex justify-center items-center gap-4">
        <img
          src="https://media.licdn.com/dms/image/v2/C4D0BAQGBX4Kj6ClDQg/company-logo_100_100/company-logo_100_100/0/1676392838415?e=1750291200&v=beta&t=UdYGePIQI7kEVfoGLedqdFrpVi26pNdPBDl3f_bcsN0"
          alt=""
          className="w-9"
        />
